            ...
            <div className='w-full max-w-[440px] flex flex-col gap-8'>
                ...
                <div className='text-center space-y-2'>
                    <div className='inline-flex items-center justify-center w-12 h-12 rounded-xl bg-indigo-100 text-indigo-700 mb-4 shadow-lg shadow-indigo-500/10'>
                        <img src={BagLogo} alt="Bag Logo" className="w-6 h-6" />
                    </div>
                    <h1 className='text-3xl font-bold text-slate-900 tracking-tight'>Essence</h1>
                ...
                <div className='bg-white rounded-xl shadow-sm p-8 flex flex-col gap-5 border border-slate-100'>
                    <form onSubmit={(e) => { e.preventDefault(); handleLogin(); }}>
                        ...
                        <div className='flex flex-col  gap-1.5 mb-5'>
                            <label className='text-sm font-medium text-slate-700 text-left'>Name</label>
                            <input
                        ...
                        {/* Email field */}
                        <div className='flex flex-col gap-1.5 mb-5'>
                            <label className='text-sm font-medium text-slate-700 text-left'>Email</label>
                            <input
                                className='w-full px-4 py-2.5 rounded-lg border border-slate-200 text-sm text-slate-900 placeholder:text-slate-400 outline-none focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500/10 transition'
                ...
                <div className='relative overflow-hidden rounded-xl bg-slate-950 aspect-[2/1] group shadow-xl inset-0 bg-gradient-to-t from-slate-950 via-transparent to-transparent'>
                    <img alt="Minimalist shop interior" className=" absolute inset-0 w-full h-full object-cover opacity-60 grayscale group-hover:scale-105 transition-transform duration-700" src={Shoppingimg} />
                    <div className='absolute inset-0 bg-gradient-to-t from-slate-950 via-transparent to-transparent'>
                        <div className='absolute bottom-10 left-5'>
                            <p className='text-left font-size-caption text-white/70' style={{ fontSize: 'var(--font-size-h3)' }}>New Collection</p>
                            <h3 className='font-h3 text-h3 text-white text-[18px]'>Curated for the modern minimalist</h3>
                        </div>
                    </div>
                </div>
            </div>
